...
/// <summary>
/// Retrieves detailed information about a phone number including validation, formatting,
/// country information, and available messaging channels. The customer ID is extracted
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public NumberLookupRetrieveParams(NumberLookupRetrieveParams numberLookupRetrieveParams)
...
#pragma warning restore CS8618
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v2/number-lookup")
        {
