...
[JsonConverter(
    typeof(JsonModelConverter<
        SentDmServicesCommonEntitiesTcrCampaignUseCaseProperties,
        SentDmServicesCommonEntitiesTcrCampaignUseCasePropertiesFromRaw
    >)
)]
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SentDmServicesCommonEntitiesTcrCampaignUseCaseProperties(
        SentDmServicesCommonEntitiesTcrCampaignUseCaseProperties sentDmServicesCommonEntitiesTcrCampaignUseCaseProperties
    )
        : base(sentDmServicesCommonEntitiesTcrCampaignUseCaseProperties) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="SentDmServicesCommonEntitiesTcrCampaignUseCasePropertiesFromRaw.FromRawUnchecked"/>
    public static SentDmServicesCommonEntitiesTcrCampaignUseCaseProperties FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SentDmServicesCommonEntitiesTcrCampaignUseCasePropertiesFromRaw
    : IFromRawJson<SentDmServicesCommonEntitiesTcrCampaignUseCaseProperties>
{
    /// <inheritdoc/>
    public SentDmServicesCommonEntitiesTcrCampaignUseCaseProperties FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SentDmServicesCommonEntitiesTcrCampaignUseCaseProperties.FromRawUnchecked(rawData);
}
