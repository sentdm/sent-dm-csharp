...
public sealed record class WebhookListEventTypesResponseData : JsonModel
{
    ...
    /// </summary>
    public WebhookListEventTypesResponseDataPagination? Pagination
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<WebhookListEventTypesResponseDataPagination>(
                "pagination"
            );
        }
        init
...
[JsonConverter(
    typeof(JsonModelConverter<
        WebhookListEventTypesResponseDataPagination,
        WebhookListEventTypesResponseDataPaginationFromRaw
    >)
)]
public sealed record class WebhookListEventTypesResponseDataPagination : JsonModel
{
    /// <summary>
    /// Cursor-based pagination. Never populated — see Cursors.
    /// </summary>
    [Obsolete("deprecated")]
    public WebhookListEventTypesResponseDataPaginationCursors? Cursors
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<WebhookListEventTypesResponseDataPaginationCursors>(
                "cursors"
            );
        }
    ...
    public WebhookListEventTypesResponseDataPagination() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WebhookListEventTypesResponseDataPagination(
        WebhookListEventTypesResponseDataPagination webhookListEventTypesResponseDataPagination
    )
        : base(webhookListEventTypesResponseDataPagination) { }
#pragma warning restore CS8618
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    WebhookListEventTypesResponseDataPagination(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="WebhookListEventTypesResponseDataPaginationFromRaw.FromRawUnchecked"/>
    public static WebhookListEventTypesResponseDataPagination FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class WebhookListEventTypesResponseDataPaginationFromRaw
    : IFromRawJson<WebhookListEventTypesResponseDataPagination>
{
    /// <inheritdoc/>
    public WebhookListEventTypesResponseDataPagination FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => WebhookListEventTypesResponseDataPagination.FromRawUnchecked(rawData);
}
...
[JsonConverter(
    typeof(JsonModelConverter<
        WebhookListEventTypesResponseDataPaginationCursors,
        WebhookListEventTypesResponseDataPaginationCursorsFromRaw
    >)
)]
public sealed record class WebhookListEventTypesResponseDataPaginationCursors : JsonModel
{
    /// <summary>
    ...
    public WebhookListEventTypesResponseDataPaginationCursors() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WebhookListEventTypesResponseDataPaginationCursors(
        WebhookListEventTypesResponseDataPaginationCursors webhookListEventTypesResponseDataPaginationCursors
    )
        : base(webhookListEventTypesResponseDataPaginationCursors) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="WebhookListEventTypesResponseDataPaginationCursorsFromRaw.FromRawUnchecked"/>
    public static WebhookListEventTypesResponseDataPaginationCursors FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class WebhookListEventTypesResponseDataPaginationCursorsFromRaw
    : IFromRawJson<WebhookListEventTypesResponseDataPaginationCursors>
{
    /// <inheritdoc/>
    public WebhookListEventTypesResponseDataPaginationCursors FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => WebhookListEventTypesResponseDataPaginationCursors.FromRawUnchecked(rawData);
}
