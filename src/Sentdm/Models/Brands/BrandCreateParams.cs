...
public record class BrandCreateParams : ParamsBase
{
    ...
    /// </summary>
    public required BrandData Brand
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<BrandData>("brand");
        }
...
#pragma warning restore CS8618
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v3/brands")
        {
