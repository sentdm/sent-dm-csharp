...
public class ProfileCreateResponseTest : TestBase
{
    ...
    {
        var model = new ProfileCreateResponse
        {
            Data = new()
            {
                ...
                Brand = new()
                {
                    ...
                    Compliance = new()
                    {
                        BrandRelationship = DataBrandComplianceBrandRelationship.BasicAccount,
                        ...
                        Vertical = DataBrandComplianceVertical.Professional,
                    },
                    Contact = new()
                    {
...
public class DataTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        DataBillingContact expectedBillingContact = new()
        {
            Address = "address",
            Email = "email",
            Name = "name",
...
public class DataBillingContactTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DataBillingContact
        {
            Address = "address",
            Email = "email",
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<DataBillingContact>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        DataBillingContact copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DataBrandTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DataBrand
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            Business = new()
            {
        ...
        string expectedID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e";
        DataBrandBusiness expectedBusiness = new()
        {
            City = "city",
            Country = "country",
            CountryOfRegistration = "country_of_registration",
        ...
        DataBrandCompliance expectedCompliance = new()
        {
            BrandRelationship = DataBrandComplianceBrandRelationship.BasicAccount,
            DestinationCountries = [new() { ID = "id", IsMain = true }],
            ExpectedMessagingVolume = "expected_messaging_volume",
        ...
        DataBrandContact expectedContact = new()
        {
            BusinessName = "business_name",
            Email = "email",
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<DataBrand>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<DataBrand>(
            element,
            ModelBase.SerializerOptions
        );
        Assert.NotNull(deserialized);
    ...
    public void CopyConstructor_Works()
    {
        ...
        DataBrand copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DataBrandBusinessTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DataBrandBusiness
        {
            City = "city",
            Country = "country",
            CountryOfRegistration = "country_of_registration",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<DataBrandBusiness>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        DataBrandBusiness copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DataBrandComplianceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DataBrandCompliance
        {
            BrandRelationship = DataBrandComplianceBrandRelationship.BasicAccount,
            DestinationCountries = [new() { ID = "id", IsMain = true }],
            ExpectedMessagingVolume = "expected_messaging_volume",
        ...
        ApiEnum<string, DataBrandComplianceBrandRelationship> expectedBrandRelationship =
            DataBrandComplianceBrandRelationship.BasicAccount;
        List<DataBrandComplianceDestinationCountry> expectedDestinationCountries =
        [
        ...
        ApiEnum<string, DataBrandComplianceVertical> expectedVertical =
            DataBrandComplianceVertical.Professional;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<DataBrandCompliance>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        DataBrandCompliance copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DataBrandComplianceBrandRelationshipTest : TestBase
{
    [Theory]
    [InlineData(DataBrandComplianceBrandRelationship.BasicAccount)]
    [InlineData(DataBrandComplianceBrandRelationship.MediumAccount)]
    [InlineData(DataBrandComplianceBrandRelationship.LargeAccount)]
    [InlineData(DataBrandComplianceBrandRelationship.SmallAccount)]
    [InlineData(DataBrandComplianceBrandRelationship.KeyAccount)]
    public void Validation_Works(DataBrandComplianceBrandRelationship rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DataBrandComplianceBrandRelationship> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(DataBrandComplianceBrandRelationship.SmallAccount)]
    [InlineData(DataBrandComplianceBrandRelationship.KeyAccount)]
    public void SerializationRoundtrip_Works(DataBrandComplianceBrandRelationship rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DataBrandComplianceBrandRelationship> value = rawValue;
...
public class DataBrandComplianceDestinationCountryTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DataBrandComplianceDestinationCountry { ID = "id", IsMain = true };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<DataBrandComplianceDestinationCountry>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new DataBrandComplianceDestinationCountry { };
    ...
    public void CopyConstructor_Works()
    {
        ...
        DataBrandComplianceDestinationCountry copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DataBrandComplianceVerticalTest : TestBase
{
    [Theory]
    [InlineData(DataBrandComplianceVertical.Professional)]
    [InlineData(DataBrandComplianceVertical.RealEstate)]
    [InlineData(DataBrandComplianceVertical.Healthcare)]
    [InlineData(DataBrandComplianceVertical.HumanResources)]
    [InlineData(DataBrandComplianceVertical.Energy)]
    [InlineData(DataBrandComplianceVertical.Entertainment)]
    [InlineData(DataBrandComplianceVertical.Retail)]
    [InlineData(DataBrandComplianceVertical.Transportation)]
    [InlineData(DataBrandComplianceVertical.Agriculture)]
    [InlineData(DataBrandComplianceVertical.Insurance)]
    [InlineData(DataBrandComplianceVertical.Postal)]
    [InlineData(DataBrandComplianceVertical.Education)]
    [InlineData(DataBrandComplianceVertical.Hospitality)]
    [InlineData(DataBrandComplianceVertical.Financial)]
    [InlineData(DataBrandComplianceVertical.Political)]
    [InlineData(DataBrandComplianceVertical.Gambling)]
    [InlineData(DataBrandComplianceVertical.Legal)]
    [InlineData(DataBrandComplianceVertical.Construction)]
    [InlineData(DataBrandComplianceVertical.Ngo)]
    [InlineData(DataBrandComplianceVertical.Manufacturing)]
    [InlineData(DataBrandComplianceVertical.Government)]
    [InlineData(DataBrandComplianceVertical.Technology)]
    [InlineData(DataBrandComplianceVertical.Communication)]
    public void Validation_Works(DataBrandComplianceVertical rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DataBrandComplianceVertical> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, DataBrandComplianceVertical>>(
    ...
    [InlineData(DataBrandComplianceVertical.Technology)]
    [InlineData(DataBrandComplianceVertical.Communication)]
    public void SerializationRoundtrip_Works(DataBrandComplianceVertical rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DataBrandComplianceVertical> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, DataBrandComplianceVertical>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class DataBrandContactTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DataBrandContact
        {
            BusinessName = "business_name",
            Email = "email",
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<DataBrandContact>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new DataBrandContact { Name = "name" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        DataBrandContact copied = new(model);
