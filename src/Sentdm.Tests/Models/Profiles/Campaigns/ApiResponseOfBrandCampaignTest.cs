...
public class ApiResponseOfBrandCampaignTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ApiResponseOfBrandCampaign
        {
            Data = new()
            {
        ...
        BrandCampaign expectedData = new()
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            BilledDate = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            BrandID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ApiResponseOfBrandCampaign>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ApiResponseOfBrandCampaign copied = new(model);
