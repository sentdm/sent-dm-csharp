    ...
    public void FieldRoundtrip_Works()
    {
        var model = new CampaignUpdateResponse
        {
            Data = new()
            {
                ...
                SharingStatus = CampaignUpdateResponseDataSharingStatus.Pending,
                ...
                [
                    new()
                    {
                        ...
                        CustomerID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                        MessagingUseCaseUs =
                            CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.Marketing,
        ...
        CampaignUpdateResponseError expectedError = new()
        {
            Code = "code",
            Details = new Dictionary<string, IReadOnlyList<string>>() { { "foo", ["string"] } },
            DocUrl = "doc_url",
        ...
        CampaignUpdateResponseMeta expectedMeta = new()
        {
            RequestID = "request_id",
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Version = "version",
...
public class CampaignUpdateResponseDataTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<string, CampaignUpdateResponseDataSharingStatus> expectedSharingStatus =
            CampaignUpdateResponseDataSharingStatus.Pending;
        ...
        [
            new()
            {
                ...
                CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
                CustomerID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                MessagingUseCaseUs = CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.Marketing,
                SampleMessages = ["string"],
                UpdatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            },
        ];
...
public class CampaignUpdateResponseDataSharingStatusTest : TestBase
{
    [Theory]
    [InlineData(CampaignUpdateResponseDataSharingStatus.Pending)]
    [InlineData(CampaignUpdateResponseDataSharingStatus.Accepted)]
    [InlineData(CampaignUpdateResponseDataSharingStatus.Declined)]
    public void Validation_Works(CampaignUpdateResponseDataSharingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CampaignUpdateResponseDataSharingStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(CampaignUpdateResponseDataSharingStatus.Accepted)]
    [InlineData(CampaignUpdateResponseDataSharingStatus.Declined)]
    public void SerializationRoundtrip_Works(CampaignUpdateResponseDataSharingStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CampaignUpdateResponseDataSharingStatus> value = rawValue;
...
public class CampaignUpdateResponseDataUseCaseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        ApiEnum<
            string,
            CampaignUpdateResponseDataUseCaseMessagingUseCaseUs
...
public class CampaignUpdateResponseDataUseCaseMessagingUseCaseUsTest : TestBase
{
    [Theory]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.Marketing)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.AccountNotification)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.CustomerCare)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.FraudAlert)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.TwoFa)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.DeliveryNotification)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.SecurityAlert)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.M2M)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.Mixed)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.HigherEducation)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.PollingVoting)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.PublicServiceAnnouncement)]
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.LowVolume)]
    public void Validation_Works(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CampaignUpdateResponseDataUseCaseMessagingUseCaseUs> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(CampaignUpdateResponseDataUseCaseMessagingUseCaseUs.LowVolume)]
    public void SerializationRoundtrip_Works(
        CampaignUpdateResponseDataUseCaseMessagingUseCaseUs rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, CampaignUpdateResponseDataUseCaseMessagingUseCaseUs> value = rawValue;
...
public class CampaignUpdateResponseErrorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CampaignUpdateResponseError
        {
            Code = "code",
            Details = new Dictionary<string, IReadOnlyList<string>>() { { "foo", ["string"] } },
            DocUrl = "doc_url",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CampaignUpdateResponseError>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new CampaignUpdateResponseError { Code = "code", Message = "message" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        CampaignUpdateResponseError copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class CampaignUpdateResponseMetaTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CampaignUpdateResponseMeta
        {
            RequestID = "request_id",
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Version = "version",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CampaignUpdateResponseMeta>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CampaignUpdateResponseMeta copied = new(model);
