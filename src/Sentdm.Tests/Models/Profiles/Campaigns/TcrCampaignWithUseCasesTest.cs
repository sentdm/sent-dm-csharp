...
public class SentDmServicesCommonEntitiesTcrCampaignUseCasePropertiesTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<SentDmServicesCommonEntitiesTcrCampaignUseCaseProperties>(
                json,
                ModelBase.SerializerOptions
            );
