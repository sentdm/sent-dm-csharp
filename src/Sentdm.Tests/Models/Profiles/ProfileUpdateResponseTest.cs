...
public class ProfileUpdateResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
            ...
            Data = new()
            {
                ...
                Brand = new()
                {
                    ...
                    Compliance = new()
                    {
                        ...
                        Vertical = ProfileUpdateResponseDataBrandComplianceVertical.Professional,
                    },
                    Contact = new()
                    {
                    ...
                    CspID = "csp_id",
                    IdentityStatus = ProfileUpdateResponseDataBrandIdentityStatus.SelfDeclared,
                    IsInherited = true,
                    Status = ProfileUpdateResponseDataBrandStatus.Active,
        ...
        ProfileUpdateResponseData expectedData = new()
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            AllowContactSharing = true,
            AllowNumberChangeDuringOnboarding = true,
        ...
        ProfileUpdateResponseError expectedError = new()
        {
            Code = "code",
            Details = new Dictionary<string, IReadOnlyList<string>>() { { "foo", ["string"] } },
            DocUrl = "doc_url",
        ...
        ProfileUpdateResponseMeta expectedMeta = new()
        {
            RequestID = "request_id",
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Version = "version",
...
public class ProfileUpdateResponseDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseData
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            AllowContactSharing = true,
            AllowNumberChangeDuringOnboarding = true,
        ...
        ProfileUpdateResponseDataBillingContact expectedBillingContact = new()
        {
            Address = "address",
            Email = "email",
            Name = "name",
        ...
        ProfileUpdateResponseDataBrand expectedBrand = new()
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            Business = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileUpdateResponseData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileUpdateResponseDataBillingContactTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseDataBillingContact
        {
            Address = "address",
            Email = "email",
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileUpdateResponseDataBillingContact>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseDataBillingContact copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileUpdateResponseDataBrandTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseDataBrand
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            Business = new()
            {
        ...
        string expectedID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e";
        ProfileUpdateResponseDataBrandBusiness expectedBusiness = new()
        {
            City = "city",
            Country = "country",
            CountryOfRegistration = "country_of_registration",
        ...
        ProfileUpdateResponseDataBrandCompliance expectedCompliance = new()
        {
            BrandRelationship =
                ProfileUpdateResponseDataBrandComplianceBrandRelationship.BasicAccount,
            DestinationCountries = [new() { ID = "id", IsMain = true }],
        ...
        ProfileUpdateResponseDataBrandContact expectedContact = new()
        {
            BusinessName = "business_name",
            Email = "email",
            Name = "name",
        ...
        ApiEnum<string, ProfileUpdateResponseDataBrandIdentityStatus> expectedIdentityStatus =
            ProfileUpdateResponseDataBrandIdentityStatus.SelfDeclared;
        bool expectedIsInherited = true;
        ApiEnum<string, ProfileUpdateResponseDataBrandStatus> expectedStatus =
            ProfileUpdateResponseDataBrandStatus.Active;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileUpdateResponseDataBrand>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseDataBrand copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileUpdateResponseDataBrandBusinessTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseDataBrandBusiness
        {
            City = "city",
            Country = "country",
            CountryOfRegistration = "country_of_registration",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileUpdateResponseDataBrandBusiness>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseDataBrandBusiness copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileUpdateResponseDataBrandComplianceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseDataBrandCompliance
        {
            BrandRelationship =
                ProfileUpdateResponseDataBrandComplianceBrandRelationship.BasicAccount,
            DestinationCountries = [new() { ID = "id", IsMain = true }],
        ...
        > expectedBrandRelationship =
            ProfileUpdateResponseDataBrandComplianceBrandRelationship.BasicAccount;
        List<ProfileUpdateResponseDataBrandComplianceDestinationCountry> expectedDestinationCountries =
        [
        ...
        ApiEnum<string, ProfileUpdateResponseDataBrandComplianceVertical> expectedVertical =
            ProfileUpdateResponseDataBrandComplianceVertical.Professional;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileUpdateResponseDataBrandCompliance>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseDataBrandCompliance copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileUpdateResponseDataBrandComplianceBrandRelationshipTest : TestBase
{
    [Theory]
    [InlineData(ProfileUpdateResponseDataBrandComplianceBrandRelationship.BasicAccount)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceBrandRelationship.MediumAccount)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceBrandRelationship.LargeAccount)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceBrandRelationship.SmallAccount)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceBrandRelationship.KeyAccount)]
    public void Validation_Works(ProfileUpdateResponseDataBrandComplianceBrandRelationship rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ProfileUpdateResponseDataBrandComplianceBrandRelationship> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ProfileUpdateResponseDataBrandComplianceBrandRelationship.KeyAccount)]
    public void SerializationRoundtrip_Works(
        ProfileUpdateResponseDataBrandComplianceBrandRelationship rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ProfileUpdateResponseDataBrandComplianceBrandRelationship> value = rawValue;
...
public class ProfileUpdateResponseDataBrandComplianceDestinationCountryTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseDataBrandComplianceDestinationCountry
        {
            ID = "id",
            IsMain = true,
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<ProfileUpdateResponseDataBrandComplianceDestinationCountry>(
                json,
                ModelBase.SerializerOptions
            );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseDataBrandComplianceDestinationCountry copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileUpdateResponseDataBrandComplianceVerticalTest : TestBase
{
    [Theory]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Professional)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.RealEstate)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Healthcare)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.HumanResources)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Energy)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Entertainment)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Retail)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Transportation)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Agriculture)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Insurance)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Postal)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Education)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Hospitality)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Financial)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Political)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Gambling)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Legal)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Construction)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Ngo)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Manufacturing)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Government)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Technology)]
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Communication)]
    public void Validation_Works(ProfileUpdateResponseDataBrandComplianceVertical rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ProfileUpdateResponseDataBrandComplianceVertical> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ProfileUpdateResponseDataBrandComplianceVertical.Communication)]
    public void SerializationRoundtrip_Works(
        ProfileUpdateResponseDataBrandComplianceVertical rawValue
    )
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ProfileUpdateResponseDataBrandComplianceVertical> value = rawValue;
...
public class ProfileUpdateResponseDataBrandContactTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseDataBrandContact
        {
            BusinessName = "business_name",
            Email = "email",
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileUpdateResponseDataBrandContact>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new ProfileUpdateResponseDataBrandContact { Name = "name" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseDataBrandContact copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileUpdateResponseDataBrandIdentityStatusTest : TestBase
{
    [Theory]
    [InlineData(ProfileUpdateResponseDataBrandIdentityStatus.SelfDeclared)]
    [InlineData(ProfileUpdateResponseDataBrandIdentityStatus.Unverified)]
    [InlineData(ProfileUpdateResponseDataBrandIdentityStatus.Verified)]
    [InlineData(ProfileUpdateResponseDataBrandIdentityStatus.VettedVerified)]
    public void Validation_Works(ProfileUpdateResponseDataBrandIdentityStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ProfileUpdateResponseDataBrandIdentityStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ProfileUpdateResponseDataBrandIdentityStatus.Verified)]
    [InlineData(ProfileUpdateResponseDataBrandIdentityStatus.VettedVerified)]
    public void SerializationRoundtrip_Works(ProfileUpdateResponseDataBrandIdentityStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ProfileUpdateResponseDataBrandIdentityStatus> value = rawValue;
...
public class ProfileUpdateResponseDataBrandStatusTest : TestBase
{
    [Theory]
    [InlineData(ProfileUpdateResponseDataBrandStatus.Active)]
    [InlineData(ProfileUpdateResponseDataBrandStatus.Inactive)]
    [InlineData(ProfileUpdateResponseDataBrandStatus.Suspended)]
    public void Validation_Works(ProfileUpdateResponseDataBrandStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ProfileUpdateResponseDataBrandStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ProfileUpdateResponseDataBrandStatus.Inactive)]
    [InlineData(ProfileUpdateResponseDataBrandStatus.Suspended)]
    public void SerializationRoundtrip_Works(ProfileUpdateResponseDataBrandStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ProfileUpdateResponseDataBrandStatus> value = rawValue;
...
public class ProfileUpdateResponseErrorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseError
        {
            Code = "code",
            Details = new Dictionary<string, IReadOnlyList<string>>() { { "foo", ["string"] } },
            DocUrl = "doc_url",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileUpdateResponseError>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new ProfileUpdateResponseError { Code = "code", Message = "message" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseError copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileUpdateResponseMetaTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileUpdateResponseMeta
        {
            RequestID = "request_id",
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Version = "version",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileUpdateResponseMeta>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileUpdateResponseMeta copied = new(model);
