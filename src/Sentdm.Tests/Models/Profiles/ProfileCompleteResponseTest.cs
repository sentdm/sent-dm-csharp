...
public class ProfileCompleteResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileCompleteResponse
        {
            Data = new() { Message = "message", Status = "status" },
            Error = new()
            {
                Code = "code",
        ...
        ProfileCompleteResponseData expectedData = new() { Message = "message", Status = "status" };
        ProfileCompleteResponseError expectedError = new()
        {
            Code = "code",
            Details = new Dictionary<string, IReadOnlyList<string>>() { { "foo", ["string"] } },
            DocUrl = "doc_url",
        ...
        ProfileCompleteResponseMeta expectedMeta = new()
        {
            RequestID = "request_id",
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Version = "version",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ProfileCompleteResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileCompleteResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileCompleteResponseDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileCompleteResponseData { Message = "message", Status = "status" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileCompleteResponseData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new ProfileCompleteResponseData { };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileCompleteResponseData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileCompleteResponseErrorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileCompleteResponseError
        {
            Code = "code",
            Details = new Dictionary<string, IReadOnlyList<string>>() { { "foo", ["string"] } },
            DocUrl = "doc_url",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileCompleteResponseError>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new ProfileCompleteResponseError { Code = "code", Message = "message" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileCompleteResponseError copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ProfileCompleteResponseMetaTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ProfileCompleteResponseMeta
        {
            RequestID = "request_id",
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Version = "version",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ProfileCompleteResponseMeta>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ProfileCompleteResponseMeta copied = new(model);
