...
public class ApiResponseBrandWithKycTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ApiResponseBrandWithKyc
        {
            Data = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ApiResponseBrandWithKyc>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ApiResponseBrandWithKyc copied = new(model);
