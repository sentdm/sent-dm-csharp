...
public class ContactCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ContactCreateResponse
        {
            Data = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ContactCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ContactCreateResponse copied = new(model);
...
public class DataTest : TestBase
{
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new Data { UpdatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z") };
