...
public class ContactDeleteParamsTest : TestBase
{
    ...
    {
        var parameters = new ContactDeleteParams { ID = "6ba7b810-9dad-11d1-80b4-00c04fd430c8" };
    ...
    {
        ContactDeleteParams parameters = new() { ID = "6ba7b810-9dad-11d1-80b4-00c04fd430c8" };
