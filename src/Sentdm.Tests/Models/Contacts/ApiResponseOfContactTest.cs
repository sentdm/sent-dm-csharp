...
public class ApiResponseOfContactTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ApiResponseOfContact
        {
            Data = new()
            {
        ...
        ContactResponse expectedData = new()
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            AvailableChannels = "available_channels",
            CountryCode = "country_code",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ApiResponseOfContact>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ApiResponseOfContact copied = new(model);
