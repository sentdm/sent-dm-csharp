...
public class ContactRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ContactRetrieveResponse
        {
            Data = new()
            {
        ...
        ContactRetrieveResponseData expectedData = new()
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            AvailableChannels = "available_channels",
            CountryCode = "country_code",
        ...
        ContactRetrieveResponseError expectedError = new()
        {
            Code = "code",
            Details = new Dictionary<string, IReadOnlyList<string>>() { { "foo", ["string"] } },
            DocUrl = "doc_url",
        ...
        ContactRetrieveResponseMeta expectedMeta = new()
        {
            RequestID = "request_id",
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Version = "version",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ContactRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ContactRetrieveResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ContactRetrieveResponseDataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ContactRetrieveResponseData
        {
            ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            AvailableChannels = "available_channels",
            CountryCode = "country_code",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ContactRetrieveResponseData>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ContactRetrieveResponseData copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ContactRetrieveResponseErrorTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ContactRetrieveResponseError
        {
            Code = "code",
            Details = new Dictionary<string, IReadOnlyList<string>>() { { "foo", ["string"] } },
            DocUrl = "doc_url",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ContactRetrieveResponseError>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new ContactRetrieveResponseError { Code = "code", Message = "message" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ContactRetrieveResponseError copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ContactRetrieveResponseMetaTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ContactRetrieveResponseMeta
        {
            RequestID = "request_id",
            Timestamp = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Version = "version",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ContactRetrieveResponseMeta>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ContactRetrieveResponseMeta copied = new(model);
