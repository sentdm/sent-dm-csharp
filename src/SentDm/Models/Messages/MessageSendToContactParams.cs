...
/// </summary>
public record class MessageSendToContactParams : ParamsBase
{
    ...
    /// </summary>
    public required string ContactID
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("contactId");
        }
        init { this._rawBodyData.Set("contactId", value); }
    }
    ...
    public MessageSendToContactParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MessageSendToContactParams(MessageSendToContactParams messageSendToContactParams)
        : base(messageSendToContactParams)
    {
        this._rawBodyData = new(messageSendToContactParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static MessageSendToContactParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(MessageSendToContactParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v2/messages/contact")
        {
