...
/// </summary>
public record class ContactRetrieveIDParams : ParamsBase
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ContactRetrieveIDParams(ContactRetrieveIDParams contactRetrieveIDParams)
        : base(contactRetrieveIDParams) { }
...
#pragma warning restore CS8618
    ...
    public static ContactRetrieveIDParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ContactRetrieveIDParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v2/contacts/id")
        {
