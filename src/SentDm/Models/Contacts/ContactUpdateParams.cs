...
public record class ContactUpdateParams : ParamsBase
{
    ...
    public string? DefaultChannel
    {
        get
        {
            ...
            return this._rawBodyData.GetNullableClass<string>("default_channel");
        }
        init { this._rawBodyData.Set("default_channel", value); }
    }
    ...
    public bool? OptOut
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableStruct<bool>("opt_out");
        }
        init { this._rawBodyData.Set("opt_out", value); }
    }
