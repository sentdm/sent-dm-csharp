...
/// based on configuration. The process runs in the background and calls the provided
...
/// inheriting brand/campaigns → SUBMITTED                 - If non-TCR with destination
/// country (IsMain=true) → SUBMITTED                 - Otherwise → COMPLETED</para>
///
