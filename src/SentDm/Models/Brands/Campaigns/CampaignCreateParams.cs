...
/// the specified brand. Each campaign must include at least one use case with sample messages.
///
...
public record class CampaignCreateParams : ParamsBase
{
    ...
    public required CampaignData Campaign
    {
        get
        {
            ...
            return this._rawBodyData.GetNotNullClass<CampaignData>("campaign");
        }
...
#pragma warning disable CS8618
    ...
    {
        this.BrandID = campaignCreateParams.BrandID;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/v3/brands/{0}/campaigns", this.BrandID)
        )
        {
