...
public class ApiResponseContactTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ApiResponseContact
        {
            Data = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ApiResponseContact>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ApiResponseContact copied = new(model);
